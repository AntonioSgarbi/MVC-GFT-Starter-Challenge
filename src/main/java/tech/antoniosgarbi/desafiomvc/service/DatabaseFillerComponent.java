...
public class DatabaseFillerComponent {
        ...
        private void initDatabase() {
                ...
                Participant p21 = new Participant(null, "Phill Collins", "sênior", "phillcollins@mail.test", "phil",
                                "https://upload.wikimedia.org/wikipedia/commons/3/3b/Phil_Collins_1_%28cropped%29.jpg");

                Participant p22 = new Participant(null, "Bryan Adams", "sênior", "bryanadams@mail.test", "brya",
                ...
                Participant p23 = new Participant(null, "James Hatfield", "sênior", "jameshatfield@mail.test", "jame",
                                "https://pbs.twimg.com/profile_images/563802377644290048/lwaZrs6j_400x400.jpeg");

                Participant p24 = new Participant(null, "Justin Timberlake", "sênior", "phillcollins@mail.test", "just",
                                "https://www.vagalume.com.br/justin-timberlake/images/justin-timberlake.jpg");

                Participant p25 = new Participant(null, "Adam Levine", "sênior", "adamlevine@mail.test", "adam",
